...
export default function SignUpPage() {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <div className="lg:w-1/2 bg-[#0a47de] flex flex-col justify-center items-start px-8 py-16 lg:px-16 relative overflow-hidden">
        ...
        <p className="mt-8 text-white/80 font-body text-lg max-w-md leading-relaxed">
          Sign up with your Google account to register for the Osmania University SIH 2026 Internal Hackathon.
        </p>
        ...
        <SignUp
          appearance={{
            elements: {
              ...
              formButtonPrimary: "bg-[#0a47de] hover:bg-sih-darkBlue rounded-none font-body font-bold uppercase tracking-wide",
              footerActionLink: "text-[#0a47de] hover:text-sih-darkBlue font-body",
            },
          }}
          routing="path"
          path="/sign-up"
